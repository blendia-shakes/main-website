...
export const faqItems: FaqItem[] = [
...

  {
    ...
    short: 'En gimnasios, oficinas, universidades y plazas de Guatemala City. Encuentra la más cercana en la sección Ubicaciones de este sitio.',
    long: 'Las máquinas Blendia están en lugares de alto tráfico donde la gente naturalmente busca un break de calidad: gimnasios, edificios de oficinas, universidades y centros comerciales en Guatemala City. El mapa de ubicaciones tiene dirección exacta y horario de cada máquina. Si no encuentras una cerca de ti, puedes sugerir una — estamos expandiendo activamente.',
  },
  {
    id: 'como-funciona-maquina',
    category: 'maquina',
    question: '¿Cómo funciona la máquina? ¿Es complicado?',
    short: 'Selecciona tu bebida en la pantalla táctil, paga, y en segundos tienes tu Blendia lista. Sin app, sin registro.',
    long: 'La máquina funciona como cualquier vending machine moderna: pantalla táctil para elegir categoría y sabor, pago integrado (tarjeta y efectivo), entrega en segundos. No necesitas descargar ninguna app ni crear una cuenta. Cada máquina tiene instrucciones visuales paso a paso. El proceso completo toma menos de 60 segundos.',
  },
  {
    id: 'como-pagar',
    category: 'maquina',
    question: '¿Con qué puedo pagar?',
    short: 'Tarjeta de débito, crédito y efectivo. Contactless donde esté disponible. La máquina da cambio.',
    long: 'Las máquinas Blendia aceptan tarjeta de débito y crédito (Visa, Mastercard), efectivo, y en ubicaciones seleccionadas pago contactless. No necesitas tener dinero exacto — la máquina da cambio. Si tu método de pago no funciona, hay un QR de soporte visible en cada máquina.',
  },
  {
    id: 'sabe-a-proteina',
    category: 'sabor',
    ...
    long: 'Esta es la pregunta más frecuente, y la respuesta más honesta: no se nota. Blendia fue formulada para que la proteína sea invisible en el perfil de sabor. Lo que notas es el matcha, el chai, el cacao — no el suplemento. Si esperabas el sabor artificial de un shake de proteína, te va a sorprender. Si esperabas algo rico, vas a encontrar exactamente eso.',
  },
  {
    id: 'cuanto-cuesta',
    category: 'acceso',
    question: '¿Cuánto cuesta?',
    short: 'Lattes y Shakes entre Q 30–35. Essentials desde Q 28. El precio exacto aparece en la pantalla de la máquina.',
    long: 'El precio de Blendia es comparable al de una bebida de cafetería premium — pero la ecuación cambia cuando incluye proteína real y menos azúcar. No pagas solo la bebida; pagas no tener que elegir entre lo que quieres y lo que te hace bien.',
  },
  {
    ...
    long: 'Las máquinas funcionan dentro del horario de cada establecimiento. Los gimnasios ofrecen acceso más amplio (desde las 5am en muchos casos). Oficinas y universidades siguen horario laboral. En la sección de Ubicaciones puedes ver el horario específico de cada máquina antes de ir.',
  },
