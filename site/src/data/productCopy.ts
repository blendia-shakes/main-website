...
const fichas: Record<string, ProductFicha> = {
  ...
  'essentials-midnight': {
    tagline: 'Chocolate cuando el día lo pide',
    description:
      'Lo esencial no tiene por qué ser aburrido. Doble chocolate, sabor intenso y la proteína que convierte un antojo en una decisión sin arrepentimientos.',
    emotionalBenefit: 'El chocolate que saca de cualquier mal momento.',
  ...
  'shakes-midnight': {
    ...
    description:
      'Chocolate intenso, textura shake que recuerdas desde siempre, y ningún momento incómodo después de tomarlo. El antojo que esta vez también es buena decisión.',
  ...
  'shakes-masala': {
    ...
    description:
      'Chai en un shake frío que funciona mejor de lo que suena. La bebida que descubres y no puedes dejar de pedir.',
